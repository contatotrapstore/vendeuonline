...
export function EmptySearch({ searchTerm, onClearSearch }: { searchTerm?: string; onClearSearch?: () => void }) {
  // 🔒 FIX (Bug #11): Mensagem mais útil com dicas de busca
  return (
    <div className="space-y-6">
      ...
      <div className="text-center max-w-2xl mx-auto">
        <h4 className="text-sm font-medium text-gray-900 mb-3">Dicas para melhorar sua busca:</h4>
        <ul className="text-sm text-gray-600 space-y-2 text-left list-disc list-inside">
          ...
          <li>Tente usar termos mais gerais (ex: "celular" ao invés de "smartphone Samsung Galaxy")</li>
          <li>Use menos filtros ou categorias mais amplas</li>
          <li>Experimente sinônimos ou descrições diferentes do produto</li>
        </ul>
      </div>
    </div>
  );
