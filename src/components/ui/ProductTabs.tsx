...
interface ProductTabsProps {
  ...
  // shipping removido: Sistema WhatsApp-only (entrega acordada via WhatsApp)
  warranty: string;
  className?: string;
}
...
export function ProductTabs({
  ...
  features,
  specifications,
  // shipping removido: Sistema WhatsApp-only
  warranty,
  className = "",
}: ProductTabsProps) {
  ...
  const tabs = [
    ...
    // Aba "Entrega" removida: Sistema WhatsApp-only
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      // Case "shipping" removido: Sistema WhatsApp-only (entrega acordada via WhatsApp)
