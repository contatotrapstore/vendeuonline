...
const CITY_OPTIONS = ["Erechim, RS", "Getúlio Vargas, RS", "Passo Fundo, RS", "Marcelino Ramos, RS"];
...
export default function HeroSection() {
  ...
  // 🔒 FIX (Bug #2): Buscar stats reais do backend
  useEffect(() => {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    navigate(`/produtos?search=${encodeURIComponent(query.trim())}&city=${encodeURIComponent(selectedCity)}`);
  };
        ...
        <div className="max-w-5xl mx-auto mb-20">
          ...
          >
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="md:w-72">
                <div className="relative group">
                  ...
                  <select
                    ...
                    className="w-full pl-12 pr-10 py-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 appearance-none shadow-sm hover:shadow-md focus:shadow-lg transition-all duration-300 text-lg"
                  >
              ...
              <button
                type="submit"
                className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-10 py-4 rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all duration-300 font-semibold text-lg shadow-lg hover:shadow-xl transform hover:scale-105 active:scale-95"
              >
                Buscar
              </button>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
          <div className="group">
            <div className="flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
              ...
              <span className="text-4xl font-bold">
                {loading ? "..." : stats.sellers > 0 ? `${stats.sellers}+` : "0"}
              </span>
            </div>
          ...
          <div className="group">
            <div className="flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
              ...
              <span className="text-4xl font-bold">
                {loading ? "..." : stats.products > 0 ? `${stats.products}+` : "0"}
              </span>
            </div>
          ...
          <div className="group">
            <div className="flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
              ...
              <span className="text-4xl font-bold">
                {loading ? "..." : stats.avgRating > 0 ? stats.avgRating.toFixed(1) : "0.0"}
              </span>
            </div>
