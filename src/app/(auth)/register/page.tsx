...
export default function RegisterPage() {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      // 🔒 FIX (Bug #1): Adicionar campos de seller que estavam sendo perdidos
      if (data.userType === "seller") {
        registerData.storeName = data.storeName;
        registerData.storeDescription = data.storeDescription;
        registerData.zipCode = data.zipCode;
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      {/* 🔒 FIX (Bug #2): 9 categorias ordenadas alfabeticamente */}
