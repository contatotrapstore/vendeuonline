  ...
  const sections = [
    ...
    },
    {
      ...
      content: [
        ...
        "Nosso Encarregado de Proteção de Dados (DPO) pode ser contatado através do e-mail: " +
      ...
      <div className="bg-gradient-to-br from-blue-600 to-purple-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-blue-200 mt-4">Última atualização: {lastUpdated}</p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-green-50 border border-green-200 rounded-2xl p-6 mb-8">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-green-900 mb-2">Conformidade com a LGPD</h3>
                <p className="text-green-800 leading-relaxed">
                  Esta política está em total conformidade com a Lei Geral de Proteção de Dados (Lei nº 13.709/2018).
                  Respeitamos todos os seus direitos como titular de dados e implementamos as melhores práticas de
          ...
          <div className="mt-12 bg-gradient-to-br from-blue-600 to-purple-600 rounded-2xl p-8 text-white">
            ...
            <p className="text-blue-100 mb-6">Para exercer seus direitos ou esclarecer dúvidas sobre esta política:</p>
            ...
            <div className="mt-6 pt-6 border-t border-blue-400">
              ...
              <p className="text-sm text-blue-200">
                Você também pode registrar reclamações junto à Autoridade Nacional de Proteção de Dados (ANPD) através
                do site: https://www.gov.br/anpd
              </p>
            </div>
          </div>
