      ...
      <div className="bg-gradient-to-br from-blue-600 to-purple-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Termos de Uso</h1>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Bem-vindo ao {APP_CONFIG.name}! Estes Termos de Uso ("Termos") regem o uso de nossa plataforma de
              marketplace localizada em {APP_CONFIG.region.fullName}. Ao acessar ou usar nossos serviços, você concorda
              em estar vinculado a estes termos.
            </p>
            <p className="text-gray-700 leading-relaxed">
              Nossa plataforma conecta vendedores e compradores locais, facilitando transações seguras e transparentes.
              Leia atentamente todos os termos antes de usar nossos serviços.
            </p>
          </div>
