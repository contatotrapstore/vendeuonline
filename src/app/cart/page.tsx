...
export default function CartPage() {
  ...
  const { items, total, itemCount, updateQuantity, removeItem, clearCart, isEmpty } = useCart();
                  ...
                  <div className="w-24 h-24 bg-gray-100 rounded-lg overflow-hidden flex-shrink-0">
                    <img
                      ...
                      onError={(e) => {
                        ...
                        target.src =
                          "https://trae-api-us.mchost.guru/api/ide/v1/text_to_image?prompt=product%20placeholder&image_size=square";
                      }}
                    />
                  </div>
            ...
            {[
              {
                ...
                price: 1299.99,
                image:
                  "https://trae-api-us.mchost.guru/api/ide/v1/text_to_image?prompt=samsung%20galaxy%20a54%20smartphone&image_size=square",
                store: "TechStore",
              },
              {
                id: "rec2",
                ...
                price: 199.99,
                image:
                  "https://trae-api-us.mchost.guru/api/ide/v1/text_to_image?prompt=jbl%20bluetooth%20headphones&image_size=square",
                store: "AudioMax",
              },
              {
                id: "rec3",
                ...
                price: 89.99,
                image:
                  "https://trae-api-us.mchost.guru/api/ide/v1/text_to_image?prompt=portable%20power%20bank%20charger&image_size=square",
                store: "TechStore",
              },
              {
                id: "rec4",
                ...
                price: 39.99,
                image:
                  "https://trae-api-us.mchost.guru/api/ide/v1/text_to_image?prompt=premium%20phone%20case%20protection&image_size=square",
