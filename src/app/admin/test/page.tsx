        ...
        <div className="grid gap-6">
            ...
            <div className="space-y-2">
              ...
              {user && (
                <>
                  ...
                  <p>
                    <strong>User Type (raw):</strong> {JSON.stringify(user.type || user.userType)}
                  </p>
                </>
              )}
            </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="space-y-2">
              ...
              <p>
                <strong>Has Permission (all):</strong> {hasPermission("all") ? "Yes" : "No"}
              </p>
              <p>
                <strong>Permissions:</strong> {JSON.stringify(permissions)}
              </p>
              {user?.admin && (
                <>
                  <p>
                    <strong>Admin ID:</strong> {user.admin.id}
                  </p>
                  <p>
                    <strong>Admin Permissions (raw):</strong> {JSON.stringify(user.admin.permissions)}
                  </p>
                </>
              )}
            </div>
