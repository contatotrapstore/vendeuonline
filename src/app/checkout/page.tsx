            ...
            {isPixPayment ? (
              <>
                ...
                {currentPayment?.pixQrCode && (
                  <div className="mb-6">
                    <img src={currentPayment.pixQrCode} alt="QR Code PIX" className="mx-auto mb-4 border rounded-lg" />
                ...
                {currentPayment?.pixCode && (
                  <div className="bg-gray-50 rounded-lg p-4 mb-6">
                    ...
                    <p className="font-mono text-sm break-all text-gray-800 mb-3">{currentPayment.pixCode}</p>
                    <button
                      onClick={copyPixCode}
                ...
                <div className="text-center">
                  <p className="text-2xl font-bold text-gray-900 mb-2">R$ {total.toFixed(2).replace(".", ",")}</p>
        ...
        <div className="flex items-center justify-center mb-8">
          <div className="flex items-center">
            ...
            <div className="w-16 h-1 bg-gray-200 mx-2">
              <div
                className={`h-full bg-blue-600 transition-all duration-300 ${step === "payment" ? "w-full" : "w-0"}`}
              />
            </div>
            <div
              className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium ${
