...
export const planSchema = z.object({
  ...
  maxPhotosPerAd: z.number().int().min(1, 'Deve permitir pelo menos 1 foto por anúncio'),
  maxHighlightsPerDay: z.number().int().min(0, 'Número de destaques não pode ser negativo'),
  supportLevel: z.enum(['EMAIL', 'CHAT', 'PHONE', 'PRIORITY']),
