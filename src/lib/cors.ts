...
function isOriginAllowed(origin: string | null): boolean {
  ...
  const allowedOrigins = isDevelopment ? CORS_CONFIG.development : CORS_CONFIG.production;
 ...
 */
export function withCors<T extends any[]>(handler: (request: Request, ...args: T) => Promise<Response> | Response) {
...
export const adminApiCors = {
  allowedOrigins: process.env.NODE_ENV === "development" ? CORS_CONFIG.development : CORS_CONFIG.production,
