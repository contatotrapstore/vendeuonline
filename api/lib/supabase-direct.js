...
export async function getAdminStats() {
  ...
  const [usersResult, productsResult, storesResult, ordersResult] = await Promise.all([
    ...
    supabaseClient.from("stores").select("*", { count: "exact", head: true }).eq("isActive", true),
