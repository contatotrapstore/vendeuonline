...
const BRANDS = [
  'Samsung', 'Apple', 'LG', 'Sony', 'Dell', 'HP', 'Nike', 'Adidas',
  'Zara', 'H&M', 'Philips', 'Brastemp', 'Electrolux', 'Whirlpool',
  'Honda', 'Toyota', 'Ford', 'Chevrolet', 'Yamaha', 'Kawasaki'
];

const PRODUCT_NAMES = [
  'Smartphone Premium', 'Notebook Gamer', 'Smart TV 55"', 'Ar Condicionado',
  'Geladeira Frost Free', 'Fogão 5 Bocas', 'Micro-ondas Digital',
  'Camiseta Básica', 'Calça Jeans', 'Tênis Esportivo', 'Jaqueta de Couro',
  'Sofá 3 Lugares', 'Mesa de Jantar', 'Cama Box', 'Guarda-roupa',
  'Bicicleta Mountain Bike', 'Esteira Elétrica', 'Halteres', 'Proteína Whey',
  'Violão Clássico', 'Teclado Musical', 'Fone de Ouvido', 'Caixa de Som Bluetooth'
];
